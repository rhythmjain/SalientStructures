...
for thisConsent_ye in consent_yes:
    ...
    for thisComponent in Valence_InstructionsComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    consent_yes.addData('valence_instructions_text.started', valence_instructions_text.tStartRefresh)
    consent_yes.addData('valence_instructions_text.stopped', valence_instructions_text.tStopRefresh)
    # check responses
    if valence_instructions_resp.keys in ['', [], None]:  # No response was made
        valence_instructions_resp.keys = None
    consent_yes.addData('valence_instructions_resp.keys',valence_instructions_resp.keys)
    if valence_instructions_resp.keys != None:  # we had a response
        consent_yes.addData('valence_instructions_resp.rt', valence_instructions_resp.rt)
    consent_yes.addData('valence_instructions_resp.started', valence_instructions_resp.tStartRefresh)
    consent_yes.addData('valence_instructions_resp.stopped', valence_instructions_resp.tStopRefresh)
